...
public:
	...
	double GetAimConeValue() const { return AimConeValue; }
	UFUNCTION(BlueprintCallable, Category = Stats)
	void SetAimConeValue(double NewValue) { ChangeValueAndDirty(AimConeValue, NewValue);}
